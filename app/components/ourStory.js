                ...
                <div className={'overflow-hidden mt-12'}>
                    {ourStory.map((story) => (
                        <div key={story.id} className={' overflow-hidden'}>
                            <p className={`text-center w-[70%] mx-auto text-xl font-serif text-gray-100`}>{story.description}</p>
                            <div className="flex flex-col-reverse lg:flex-row justify-center items-center">
                                <div className={'w-full md:w-1/2 md:h-[560px]'}>
                                    <Image className={'h-full w-full object-cover rounded-xl'} src={story.image}
                                           alt={story.description} width={500} height={700}/>
                                </div>
