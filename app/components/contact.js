...
const Contact = () => {
    return (
        <section id="contact" className="bg-slate-50 mt-16 py-16 md:py-24">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-2">
            <div>
              <form className="space-y-6">
                ...
                <button type="submit" className="w-full bg-blue-500 px-4 py-4 text-white rounded-md hover:bg-blue-700">
                  Send Message
                </button>
              </form>
            </div>
