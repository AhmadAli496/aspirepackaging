...
const Benefits = () => {
  return (
    ...
    <div className="container">
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 bg-gray-100 border border-gray-300  shadow-lg">
        {benifits.map((benifit) => (
          <div key={benifit.id} className={`${benifit.id === "1" ? " border-b md:border-l border-black/20" : " border-none"} py-3 px-4 ${benifit.colored ? "bg-blue-400 text-white/90" : ''}`}>
