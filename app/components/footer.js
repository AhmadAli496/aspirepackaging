       ...
       <footer className="bg-slate-900 text-white pt-10 pb-6">
        <div className="container mx-auto px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="text-slate-300 mb-4">
                Premium packaging solutions for businesses of all sizes. Sustainable, customizable, and innovative.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#why-choose-us" className="text-slate-300 hover:text-white">
                    Why Choose Us
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <p className="text-slate-300 mb-4">
                Subscribe to our newsletter to receive updates on new products, special offers, and packaging tips.
              </p>
          ...
          <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400">© {new Date().getFullYear()} Aspire Packaging. All rights reserved.</p>
