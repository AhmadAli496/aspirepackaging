      ...
      <footer className="bg-slate-800 text-white pt-10 pb-6">
        <div className="container mx-auto px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div>
              <h3 className="text-xl font-semibold mb-4">Aspire Packaging</h3>
              <p className="text-slate-300 mb-4">
                Premium packaging solutions for businesses of all sizes.
                Sustainable, customizable, and innovative.
              </p>
            ...
            <div>
              ...
              <p className="text-slate-300 mb-4">
                ...
                special offers, and packaging tips.
              </p>
              <form className="space-y-2">
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-lg bg-amber-400 hover:bg-amber-200 cursor-pointer"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400">
              © {new Date().getFullYear()} Aspire Packaging. All rights
              reserved.
            </p>
